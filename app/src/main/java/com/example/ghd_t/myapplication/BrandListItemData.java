...
public class BrandListItemData {
    ...
    private String brand_fieldname;
    private String brand_priceinfo;

    public BrandListItemData(Drawable icon, String brand_title, String brand_areaname, String brand_fieldname, String brand_priceinfo) {
        this.icon = icon;
        this.brand_title = brand_title;
        this.brand_areaname = brand_areaname;
        this.brand_fieldname = brand_fieldname;
